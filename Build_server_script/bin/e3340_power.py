...
class e3340_power(power):
    def __init__(self, i2c, variant=None, calibration=None):
        power.__init__(self, i2c, variant, calibration)

        # For e3340/p2598 (T18x Sunstreaker), the buses off the PCA954x MUX which contain INA226 devices are AUX1,
        ...
        # T18x Sunstreaker (e3340/p2598)
        self.pm_devs = {
            # VDD_3V3_ENET
            "VDD_3V3_ENET" : INA226(i2c_1, 0x40, 0.001, "VDD_3V3_ENET", imax=1000),
            # VDD_3V3_EMMC_CORE
            "VDD_3V3_EMMC_CORE" : INA226(i2c_1, 0x41, 0.05, "VDD_3V3_EMMC_CORE", imax=400),
            # VDD_SYS_5V0_REG
            "VDD_SYS_5V0_REG" : INA226(i2c_1, 0x42, 0.01, "VDD_SYS_5V0_REG", imax=3000),
            # VDD_CVM_MAIN
            "VDD_CVM_MAIN" : INA226(i2c_1, 0x43, 0.01, "VDD_CVM_MAIN", imax=11200),
            # VDD_CVM_C2
            "VDD_CVM_C2" : INA226(i2c_1, 0x44, 0.01, "VDD_CVM_C2", imax=5000),
            # SYS_3V8_C1
            "SYS_3V8_C1" : INA226(i2c_1, 0x45, 0.001, "SYS_3V8_C1", imax=18000),
            # SYS_3V8_C2
            "SYS_3V8_C2" : INA226(i2c_1, 0x46, 0.001, "SYS_3V8_C2", imax=16000),
            # VDD_CVM_C1
            "VDD_CVM_C1" : INA226(i2c_1, 0x47, 0.01, "VDD_CVM_C1", imax=5000),
            # VDD_SYS_3V3_AO
            "VDD_SYS_3V3_AO" : INA226(i2c_1, 0x48, 0.1, "VDD_SYS_3V3_AO", imax=600),
            # PMIC_SD0
            ...
            # SOC_REG
            "SOC_REG" : INA226(i2c_2, 0x4C, 0.001, "SOC_REG", imax=6000),
            # VDD_1V8_EMMC_IO
            ...
            # VDD_RTC_AP
            "VDD_RTC_AP" : INA226(i2c_3, 0x40, 0.1, "VDD_RTC_AP", imax=130),
            # VDD_1V1_SD0_OUT
            "VDD_1V1_SD0_OUT" : INA226(i2c_3, 0x41, 0.001, "VDD_1V1_SD0_OUT", imax=8000),
            # VDD_GPU
            "VDD_GPU" : INA226(i2c_3, 0x42, 0.001, "VDD_GPU", imax=26000),
            # VDD_MCPU
            "VDD_MCPU" : INA226(i2c_3, 0x43, 0.001, "VDD_MCPU", imax=13500),
            # VDD_SOC
            ...
            # VDD_1V8_SDMMC4_AP
            "VDD_1V8_SDMMC4_AP" : INA226(i2c_3, 0x4A, 0.03, "VDD_1V8_SDMMC4_AP", imax=252)
            }
        ...
        self.pm_subsets = {
            ...
            "GPU" : ["+GPU_REG"],
            "CORE" : ["+SOC_REG"],
            "DRAM" : ["+VDD_1V8_SD2_OUT_LSW", "+VDD_1V1_SD0_OUT"],
            "APRAM" : ["+CPU_REG", "+GPU_REG", "+SOC_REG", "+VDD_1V8_SD2_OUT_LSW", "+VDD_1V1_SD0_OUT", "+SRAM_REG"]
            }
